namespace InterviewPreperationGuide.Core.CrackingTheCodingInterview.Chapter10 {
    /// <summary>
    ...
    /// For example, in the array { 5, 8, 6, 2, 3, 4, 6}, {8, 6}
    /// are peaks and {S, 2} are valleys.Given an array
