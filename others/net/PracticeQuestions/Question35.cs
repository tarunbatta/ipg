...
namespace InterviewPreperationGuide.App.PracticeQuestions {
    ...
    /// write a program to output the skyline formed by these buildings collectively (Figure B, refer to Leetcode link).
    ///
    ...
    /// is merely used to mark the termination of the skyline, and always has zero height.Also,
